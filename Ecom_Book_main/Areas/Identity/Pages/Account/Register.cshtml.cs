...
namespace Ecom_Book_main.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            Input = new InputModel();
            {
                ...
                Input.RoleList = _roleManager.Roles.Where(r => r.Name != SD.Role_Indivdual).Select(r => r.Name).Select(rl => new SelectListItem()
                {
                    Text = rl,
                    Value = rl
                });
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.Role_Indivdual))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.Role_Indivdual));
                    }
                    //await _userManager.AddToRoleAsync(user, SD.Role_Admin);
                    if(Input.Role==null&& Input.CompanyId == null)
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_Indivdual);
                    }
                    else
                    {
                    ...
                    {
                        if (User.IsInRole(SD.Role_Indivdual) || user.Role == null)
                        {
